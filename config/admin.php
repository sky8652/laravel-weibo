...
return [
    ...
    */
    ...
    |
    */
    'layout' => ['sidebar-collapse', 'layout-top-nav'],
    ...
    |
    */
    'login_background_image' => '/vendor/laravel-admin/AdminLTE/dist/img/5.jpg',
    ...
    |--------------------------------------------------------------------------
    |
    | 是否在页面的右下角显示当前laravel-admin的版本(true or false)
    |
    */
    'show_version' => false,
